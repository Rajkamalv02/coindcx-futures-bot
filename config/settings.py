...
CONFIRM_INTERVAL = "240"     # higher TF for MTF confirmation
...
# ── Signal Scoring ─────────────────────────────────────
MIN_SCORE = 4                # minimum score out of 5 to send alert
...
ENABLE_AUTO_TRADING  = True   # set False to disable order placement